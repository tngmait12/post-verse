                                        ...
                                        <div class="col-md-12 col-lg-12">
                                            <form action="code.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="name" value="<?= $post_data['name']; ?>" name="name" required placeholder="Enter Name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="slug" class="fw-bold">Slug (URL)</label>
                                                    <input type="text" class="form-control" id="slug" name="slug" value="<?= $post_data['slug']; ?>" required placeholder="Enter Slug">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <?php if (!empty($post_data['image'])): ?>
                                                        <img src="../uploads/posts/<?= $post_data['image']; ?>" width="100px" class="mt-2">
                                                    <?php endif; ?>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="meta_title" value="<?= $post_data['meta_title']; ?>" name="meta_title" placeholder="Enter Meta Title">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    ?>
                                                        <select name="category_id" required class="form-control">
                                                            ...
                                                            ?>
                                                                <option value="<?= $cat_item['id']; ?>" <?= $post_data['category_id'] == $cat_item['id'] ? 'selected' : ''; ?>>
                                                                    <?= $cat_item['name']; ?>
                                                                </option>
                                                            <?php
                                                            }
