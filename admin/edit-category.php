                                        ...
                                        <div class="col-md-12 col-lg-12">
                                            <form action="code.php" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="name" name="name" value="<?= $cat_data['name']; ?>" required placeholder="Enter Name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="slug" class="fw-bold">Slug (URL)</label>
                                                    <input type="text" class="form-control" id="slug" name="slug" value="<?= $cat_data['slug']; ?>" required placeholder="Enter Slug">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group mt-3">
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input" name="navbar_status" <?= $cat_data['navbar_status'] == '1' ? 'checked' : '' ?> type="checkbox">
                                                    </div>
                                                </div>
                                                <div class="form-group mt-3">
                                                    <div class="form-check">
