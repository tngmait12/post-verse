...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 24, 2025 lúc 02:43 AM
...
(1, 'HTML', 'html-slug', 'asdas', 'HTMLMMMMMM', 'asdas', 'dsadasd', 0, 0, '2025-10-02 08:13:02'),
(2, 'PHP', 'php-subject', 'Hahahahha', 'PHP Languege', 'PHP LanguegePHP LanguegePHP LanguegePHP LanguegePHP Languege', 'PHP', 0, 0, '2025-10-02 08:17:00');
...
INSERT INTO `posts` (`id`, `name`, `slug`, `description`, `image`, `meta_title`, `meta_description`, `meta_keyword`, `status`, `created_at`, `category_id`, `user_id`) VALUES
(1, 'Hướng dẫn học PHP cho người mới', 'huong-dan-hoc-php-cho-nguoi-moi', 'Bài viết này sẽ hướng dẫn chi tiết cách bắt đầu học PHP từ cơ bản đến nâng cao.\n', '1759487484.png', 'Học PHP cơ bản cho người mới | Redamancy Blog', 'Khám phá lộ trình học PHP từ A-Z dành cho người mới bắt đầu. Bài viết chi tiết, dễ hiểu, có ví dụ minh họa.\r\n', 'PHP, học PHP, PHP cho người mới, lập trình web\r\n', 0, '2025-10-02 09:35:40', 2, 1),
(13, 'Giới thiệu về trí tuệ nhân tạo', 'gioi-thieu-ve-tri-tue-nhan-tao', '<p>&nbsp;</p>\r\n\r\n<h2><strong>H&agrave;nh tr&igrave;nh bắt đầu</strong></h2>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong><strong>Blog</strong> kh&ocirc;ng chỉ l&agrave; nơi chia sẻ cảm x&uacute;c m&agrave; c&ograve;n l&agrave; h&agrave;nh tr&igrave;nh ghi lại những dấu ấn trong cuộc sống.</strong></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<blockquote><strong>&quot;Viết để hiểu m&igrave;nh hơn, viết để kết nối với thế giới.&quot;</strong></blockquote>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong>Bắt đầu từ những b&agrave;i viết đầu ti&ecirc;n, t&ocirc;i học được c&aacute;ch <em>ki&ecirc;n nhẫn</em> v&agrave; <em>chia sẻ ch&acirc;n th&agrave;nh</em>.</strong></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><strong><img alt=\"Blog journey\" src=\"uploads/blog1.jpg\" /></strong></p>\r\n', '1760402963.png', 'Giới thiệu trí tuệ nhân tạo', 'Tìm hiểu khái niệm AI và ứng dụng trong đời sống.', 'AI, trí tuệ nhân tạo, công nghệ', 0, '2025-10-12 08:22:16', 1, 1),
(16, 'Tác động của mạng xã hội đến giới trẻ', 'tac-dong-cua-mang-xa-hoi-den-gioi-tre', '<p>Mạng x&atilde; hội c&oacute; ảnh hưởng mạnh mẽ đến <em>tư duy v&agrave; h&agrave;nh vi</em> của giới trẻ hiện nay.</p>\r\n', 'social.jpg', 'Tác động của mạng xã hội', 'Phân tích mặt tích cực và tiêu cực của mạng xã hội.', 'mạng xã hội, giới trẻ, facebook, tiktok', 0, '2025-10-12 08:22:16', 1, 1),
(17, 'Cách tối ưu SEO cho website cá nhân', 'cach-toi-uu-seo-cho-website-ca-nhan', '<p>SEO gi&uacute;p website của bạn hiển thị tr&ecirc;n Google. H&atilde;y bắt đầu với <strong>meta tag, từ kh&oacute;a v&agrave; tốc độ tải trang</strong>.</p>\r\n', '1763661513.jpg', 'Tối ưu SEO website', 'Hướng dẫn SEO cơ bản cho người mới.', 'SEO, google, tối ưu, website', 0, '2025-10-12 08:22:16', 1, 1),
(18, 'Top 10 ngôn ngữ lập trình được ưa chuộng', 'top-10-ngon-ngu-lap-trinh-duoc-ua-chuong', '<ul><li>Python</li><li>JavaScript</li><li>Java</li><li>C#</li><li>PHP</li></ul>', 'coding.jpg', 'Top ngôn ngữ lập trình ưa chuộng', 'Danh sách 10 ngôn ngữ lập trình phổ biến nhất năm nay.', 'lập trình, ngôn ngữ, python, javascript', 1, '2025-10-12 08:22:16', 1, 1),
(19, 'Tại sao nên học lập trình sớm?', 'tai-sao-nen-hoc-lap-trinh-som', '<p>Học lập trình giúp trẻ phát triển <b>tư duy logic</b> và khả năng giải quyết vấn đề.</p>', 'kidcode.jpg', 'Học lập trình sớm', 'Lợi ích của việc học lập trình từ nhỏ.', 'lập trình, học sinh, giáo dục, logic', 1, '2025-10-12 08:22:16', 1, 1),
(20, 'Cách bảo mật tài khoản mạng xã hội', 'cach-bao-mat-tai-khoan-mang-xa-hoi', '<p>Bạn nên bật <strong>xác thực hai lớp</strong> và tránh dùng mật khẩu trùng nhau.</p>', 'security.jpg', 'Bảo mật tài khoản mạng xã hội', 'Hướng dẫn tăng cường bảo mật cá nhân trên Facebook, Instagram,...', 'bảo mật, tài khoản, facebook, instagram', 1, '2025-10-12 08:22:16', 1, 1),
(21, 'Hướng dẫn cài đặt PHP và XAMPP', 'huong-dan-cai-dat-php-va-xampp', '<p>Bài viết giúp bạn <b>cài đặt môi trường PHP</b> để bắt đầu học lập trình web.</p>', 'php.jpg', 'Hướng dẫn cài đặt PHP', 'Cách cài đặt và chạy PHP bằng XAMPP trên máy tính.', 'PHP, XAMPP, web, hướng dẫn', 1, '2025-10-12 08:22:16', 1, 1),
(22, 'Tương lai của công việc với AI', 'tuong-lai-cua-cong-viec-voi-ai', '<p>AI đang thay đổi cách chúng ta làm việc, từ tự động hóa đến sáng tạo nội dung.</p>', 'futureai.jpg', 'Tương lai công việc và AI', 'AI sẽ ảnh hưởng thế nào đến công việc trong 10 năm tới?', 'AI, tương lai, việc làm, tự động hóa', 1, '2025-10-12 08:22:16', 1, 1);
INSERT INTO `posts` (`id`, `name`, `slug`, `description`, `image`, `meta_title`, `meta_description`, `meta_keyword`, `status`, `created_at`, `category_id`, `user_id`) VALUES
...
(1, 'Truong Vu', 'Tong Mai', 'tongmaitruongvu11@gmail.com', '$2y$10$moojnNqL3gF4UrYh9/tKfeKm6Y.Q8r3jXwPW0z4pfCumUUkMw7E86', 1, 0, '2025-09-30 15:04:05', 'male', '0382345491', '1763660751.jpg', NULL, NULL, NULL, NULL),
